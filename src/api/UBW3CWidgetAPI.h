...
class UBW3CWidgetAPI : public QObject
{
    ...
    public:
        ...
        // WistOpenboard fork: open URL in the OS default browser via
        // QDesktopServices::openUrl, bypassing OpenBoard's internal web view.
        // Used by widgets that need a real external browser (e.g. YouTube
        // videos with embedding restrictions, where the internal browser also
        // fails because YouTube checks the embedding origin).
