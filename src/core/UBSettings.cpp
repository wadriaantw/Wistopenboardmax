...
QString UBSettings::documentLastVisitedPage = QString("LastVisitedPage");
...
void UBSettings::init()
{
    ...
    appStartMode = new UBSetting(this, "App", "StartMode", "2");
    lastOpenedDocumentPath = new UBSetting(this, "App", "LastOpenedDocumentPath", "");
    lastOpenedSceneIndex = new UBSetting(this, "App", "LastOpenedSceneIndex", 0);
