...
class UBSettings : public QObject
{
    ...
    public:
        ...
        static QString documentLastVisitedPage;
        ...
        UBSetting* appDarkTheme; // WistOpenboard fork
        UBSetting* appZenHintShown; // WistOpenboard fork
        ...
        UBSetting* lastOpenedDocumentPath;
        UBSetting* lastOpenedSceneIndex;
