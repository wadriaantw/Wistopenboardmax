...
void UBGraphicsDelegateFrame::setResizeHandlesVisible(bool visible)
{
    if (mBottomRightResizeGripSvgItem) mBottomRightResizeGripSvgItem->setVisible(visible);
    if (mBottomResizeGripSvgItem)      mBottomResizeGripSvgItem->setVisible(visible);
    if (mLeftResizeGripSvgItem)        mLeftResizeGripSvgItem->setVisible(visible);
    if (mRightResizeGripSvgItem)       mRightResizeGripSvgItem->setVisible(visible);
    if (mTopResizeGripSvgItem)         mTopResizeGripSvgItem->setVisible(visible);
    if (mRotateButton)                 mRotateButton->setVisible(visible);
}

void UBGraphicsDelegateFrame::showSingleBottomRightResizeHandle()
{
    if (mBottomRightResizeGripSvgItem) mBottomRightResizeGripSvgItem->setVisible(true);
    if (mBottomResizeGripSvgItem)      mBottomResizeGripSvgItem->setVisible(false);
    if (mLeftResizeGripSvgItem)        mLeftResizeGripSvgItem->setVisible(false);
    if (mRightResizeGripSvgItem)       mRightResizeGripSvgItem->setVisible(false);
    if (mTopResizeGripSvgItem)         mTopResizeGripSvgItem->setVisible(false);
    if (mRotateButton)                 mRotateButton->setVisible(false);
}
